...
def menu():
    ...
    <div class="card">
        ...
        <div class="menu-container">
            ...
            <a href='/withdraw' class="menu-link">💸 Fast Cash / Withdrawal</a>
            <a href='/balance' class="menu-link">🏦 Balance Enquiry</a>
            <a href='/change_pin' class="menu-link">🔒 PIN Change</a>
            <a href='/history' class="menu-link">📜 Mini Statement</a>
        </div>
...
# =========================================
# 7. SECURITY CREDENTIAL CONFIGURATION
# =========================================
